<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="lookuporder.aspx.vb" Inherits="PassholderAdmin.lookuporder" %>
...
<body>
    ...
    border-top: 1px solid #666666;
        ...
        table.tablepaymenthistory {
    width: 1039px;
    margin-bottom: 50px;
}

    </style>
    <asp:Panel ID="pnlContent" CssClass="holdbox" runat="server">
        <h1>Lookup Online Order</h1>

        <p><asp:DropDownList ID="fldSearchType" runat="server">
            <asp:ListItem Value="1">Accesso Order Number</asp:ListItem>
            <asp:ListItem Value="2">Media Number</asp:ListItem>
            </asp:DropDownList><br />
